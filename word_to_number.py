def text2int(textnum, numwords={}):
    if not numwords:
      units = {
        "zero": 0, "unu": 1, "una": 1, "un": 1, "o": 1, "doi": 2, "doua": 2, "trei": 3, "patru": 4, "cinci": 5, "sase": 6, "sapte": 7, "opt": 8,
        "noua": 9, "zece": 10, "unsprezece": 11, "doisprezece": 12, "treisprezece": 13, "paisprezece": 14, "cincisprezece": 15,
      ...
      scales = {"suta": 2, "sute": 2, "mie": 3, "mii": 3, "milioane": 4, "milion": 4, "miliarde": 5, "miliard": 5, "trilioane": 6, "trilion": 6}
    ...
    ordinal_words = {'primul': 1, 'aldoilea': 2, 'altreilea': 3, 'alcincilea': 5, 'aloptulea': 8, 'alnoulea': 9, 'aldoisprecelea': 12}
...
print(text2int("douasutepatruzecisidoi"))